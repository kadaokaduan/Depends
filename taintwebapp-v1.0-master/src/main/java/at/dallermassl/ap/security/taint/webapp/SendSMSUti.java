...
public class SendSMSUti {
    ...
    // 自己的AK
    private static final String accessKeyId = "LTAI5tAg366XXtmsyHQ3Uy4C";// 你的accessKeyId
    private static final String accessKeySecret = "1r5FkCScabMcoLvvaFSsf20MOdUZzN";// 你的accessKeySecret
    private static final String signName = "阿里云短信测试";// 签名
    private static final String templateCode = "SMS_154950909";// 短信模板
