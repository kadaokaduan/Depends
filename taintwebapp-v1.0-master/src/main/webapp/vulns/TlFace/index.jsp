...
<%@ page import="at.dallermassl.ap.security.taint.webapp.DetectFace" %>
<%@ page contentType="text/html; charset=UTF-8" %>
<html>
<head>
    <meta charset="UTF-8" />
    <title>034 - 腾讯云人脸识别 - commons.io 方式</title>
</head>
<body>
<h1>034 - 腾讯云人脸识别 - commons.io 方式</h1>
<%
            ...
            if (isMultipart) {
                ...
                for (FileItem item: items) {
                    if(!item.isFormField()){
                        ...
                        String restr = Face.Contrast(filepath,filepath);
